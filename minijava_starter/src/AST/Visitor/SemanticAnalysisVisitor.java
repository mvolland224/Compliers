...
public class SemanticAnalysisVisitor implements ObjectVisitor {
	...
	// Exp e1,e2; 
	// DO THIS ASSIGNMENT 6
	public Object visit(Div n) {
		//this part is the same as minus
		String string1 = checkIntType(( n.e1 != null ) ? n.e1.accept(this) : null);
		String string2 = checkIntType(( n.e2 != null ) ? n.e2.accept(this) : null);
		
		//same as minus
		if ( string1 != string2 || string1 != "int") {
			report_error(n.getLineNo(), "Expecting int operand types in divide operation.");
			return null;
		}
		
		//checks when dividing by 0 errors
		//the difference from minus
		
		if (n.e2 instanceof IntegerLiteral) {
			IntegerLiteral m = (IntegerLiteral)n.e2;
			
			if (m.i == 0) report_error(n.getLineNo(), "Cannot divide by 0");
